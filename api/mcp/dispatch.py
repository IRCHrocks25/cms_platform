...
def dispatch(
    ...
    if method == "tools/call":
        ...
        # publish_site, publish_page, delete_page, add_custom_domain, and
        # verify_custom_domain are superuser-only; audit after so member
        # denials never stamp a tenant they could otherwise for_tenant()
        # (same reasoning as publish_site).
        if name in (
