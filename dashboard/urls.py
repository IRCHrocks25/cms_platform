...
urlpatterns = [
    ...
    path("sites/<int:pk>/custom-domain/<int:domain_pk>/verify/", views.tenant_custom_domain_verify, name="tenant_custom_domain_verify"),
    path("sites/<int:pk>/custom-domain/<int:domain_pk>/delete/", views.tenant_custom_domain_delete, name="tenant_custom_domain_delete"),
    ...
    path("sites/<int:pk>/pages/rename/", views.page_rename, name="page_rename"),
    path("sites/<int:pk>/pages/nav-order/", views.page_nav_reorder, name="page_nav_reorder"),
    ...
    path("sites/<int:pk>/pages/<int:page_pk>/edit-html/", views.page_edit_html, name="page_edit_html"),
    ...
    path("sites/<int:pk>/ghl/forms/", views.tenant_ghl_forms, name="tenant_ghl_forms"),
    ...
    path("sites/<int:pk>/media/", views.tenant_media_gallery, name="tenant_media_gallery"),
    path("sites/<int:pk>/media/<int:asset_id>/", views.tenant_media_item, name="tenant_media_item"),
    ...
    path("integrations/disconnect-agency/", views.integrations_disconnect_agency,
         name="integrations_disconnect_agency"),
    path("integrations/rename-agency/", views.integrations_rename_agency,
         name="integrations_rename_agency"),
    ...
    path("editor/ghl/forms/", views.tenant_ghl_forms_self, name="tenant_ghl_forms_self"),
    ...
    path("editor/media/", views.tenant_media_gallery_self, name="tenant_media_gallery_self"),
    path("editor/media/<int:asset_id>/", views.tenant_media_item_self, name="tenant_media_item_self"),
    ...
    path("pages/nav-order/", views.page_nav_reorder_self, name="page_nav_reorder_self"),
    path("pages/<int:page_pk>/rename/", views.page_rename_self, name="page_rename_self"),
    ...
    path("pages/<int:page_pk>/versions/", views.page_versions_self, name="page_versions_self"),
    path("pages/<int:page_pk>/versions/restore/", views.page_version_restore_self, name="page_version_restore_self"),
    path("pages/<int:page_pk>/versions/<int:version_id>/preview/", views.page_version_preview_self, name="page_version_preview_self"),
